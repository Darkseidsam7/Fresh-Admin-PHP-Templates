...
<html>
<head>
<title>Augment an Admin Panel Category Flat Bootstrap Responsive Web Template | Login :: SAMTPOINT</title>
														...
														<h3 class="inner-tittle t-inner">Login</h3>
																...
																<form>
																		...
																		<div class="new">
																			...
																			<p class="sign">Do not have an account ? <a href="sign.php">Sign Up</a></p>
																			<div class="clearfix"></div>
																		</div>
																	</form>
														</div>
